...
public final class EquationSolver{
    ...
    private static boolean infinityFlag = false; // used when exponents are too large
    ...
    private static String doOperation(String lhs, char operator, String rhs) {
        try {
            ...
            infinityFlag = true; // infinity or NaN
            return "";
        }
    }
    ...
    public static String solver(String equation) {
        if(isSolvable(equation)) {
            ...
            value = parse(value);
            if(infinityFlag) {
                infinityFlag = false; // unset
                return "Infinity";
            } else {
                return value; //	returning the final value of the expression
            }
        } else return "";
    }
